...
func init() {
	file_nova_ism_v1_query_proto_init()
	md_QueryPaused = File_nova_ism_v1_query_proto.Messages().ByName("QueryPaused")
}
...
func (x *QueryPaused) slowProtoReflect() protoreflect.Message {
	mi := &file_nova_ism_v1_query_proto_msgTypes[0]
...
func (x *fastReflection_QueryPaused) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.ism.v1.QueryPaused"))
		}
		panic(fmt.Errorf("message nova.ism.v1.QueryPaused does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryPaused) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message nova.ism.v1.QueryPaused does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryPaused) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in nova.ism.v1.QueryPaused", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_nova_ism_v1_query_proto_init()
	md_QueryPausedResponse = File_nova_ism_v1_query_proto.Messages().ByName("QueryPausedResponse")
...
func (x *QueryPausedResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_nova_ism_v1_query_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryPausedResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "nova.ism.v1.QueryPausedResponse.paused":
		return x.Paused != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.ism.v1.QueryPausedResponse"))
		}
		panic(fmt.Errorf("message nova.ism.v1.QueryPausedResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryPausedResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message nova.ism.v1.QueryPausedResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryPausedResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nova.ism.v1.QueryPausedResponse.paused":
		panic(fmt.Errorf("field paused of message nova.ism.v1.QueryPausedResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.ism.v1.QueryPausedResponse"))
		}
...
func (x *fastReflection_QueryPausedResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in nova.ism.v1.QueryPausedResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func (*QueryPaused) Descriptor() ([]byte, []int) {
	return file_nova_ism_v1_query_proto_rawDescGZIP(), []int{0}
}
...
func (*QueryPausedResponse) Descriptor() ([]byte, []int) {
	return file_nova_ism_v1_query_proto_rawDescGZIP(), []int{1}
}
...
var File_nova_ism_v1_query_proto protoreflect.FileDescriptor

var file_nova_ism_v1_query_proto_rawDesc = []byte{
	0x0a, 0x17, 0x6e, 0x6f, 0x76, 0x61, 0x2f, 0x69, 0x73, 0x6d, 0x2f, 0x76, 0x31, 0x2f, 0x71, 0x75,
	0x65, 0x72, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x6e, 0x6f, 0x76, 0x61, 0x2e,
	0x69, 0x73, 0x6d, 0x2e, 0x76, 0x31, 0x1a, 0x11, 0x61, 0x6d, 0x69, 0x6e, 0x6f, 0x2f, 0x61, 0x6d,
	...
	,
...
var (
	file_nova_ism_v1_query_proto_rawDescOnce sync.Once
	file_nova_ism_v1_query_proto_rawDescData = file_nova_ism_v1_query_proto_rawDesc
)

func file_nova_ism_v1_query_proto_rawDescGZIP() []byte {
	file_nova_ism_v1_query_proto_rawDescOnce.Do(func() {
		file_nova_ism_v1_query_proto_rawDescData = protoimpl.X.CompressGZIP(file_nova_ism_v1_query_proto_rawDescData)
	})
	return file_nova_ism_v1_query_proto_rawDescData
}

var file_nova_ism_v1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_nova_ism_v1_query_proto_goTypes = []interface{}{
	(*QueryPaused)(nil),         // 0: nova.ism.v1.QueryPaused
	(*QueryPausedResponse)(nil), // 1: nova.ism.v1.QueryPausedResponse
}
var file_nova_ism_v1_query_proto_depIdxs = []int32{
	0, // 0: nova.ism.v1.Query.Paused:input_type -> nova.ism.v1.QueryPaused
	1, // 1: nova.ism.v1.Query.Paused:output_type -> nova.ism.v1.QueryPausedResponse
...
func init() { file_nova_ism_v1_query_proto_init() }
func file_nova_ism_v1_query_proto_init() {
	if File_nova_ism_v1_query_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_nova_ism_v1_query_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_nova_ism_v1_query_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_nova_ism_v1_query_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_nova_ism_v1_query_proto_goTypes,
		DependencyIndexes: file_nova_ism_v1_query_proto_depIdxs,
		MessageInfos:      file_nova_ism_v1_query_proto_msgTypes,
	}.Build()
	File_nova_ism_v1_query_proto = out.File
	file_nova_ism_v1_query_proto_rawDesc = nil
	file_nova_ism_v1_query_proto_goTypes = nil
	file_nova_ism_v1_query_proto_depIdxs = nil
}
